...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, ScrollView, SafeAreaView, Modal, Alert } from 'react-native';
import { Camera, ArrowLeft, ImageIcon, X, Check } from 'lucide-react-native';
import Button from '../components/Button';
import Avatar from '../components/Avatar';
import { colors } from '../styles/colors';
import { PRONOUN_OPTIONS } from '../data/mockData';

const EditProfileScreen = ({ user, onSave, onCancel }) => {
    ...
    const handleSave = () => {
        if (!profileData.name || !profileData.pronouns) {
            Alert.alert("Missing Information", "Please provide your name and pronouns.");
            return;
        }
        onSave(profileData);
    };
...
const styles = StyleSheet.create({
    ...
    saveBtn: { padding: 8, borderRadius: 20, backgroundColor: 'rgba(99, 102, 241, 0.1)' },
